...
export default function Footer() {
  return (
    <footer className="bg-[#022524] text-white border-t border-white/10">
      <div className="container mx-auto px-6 py-12 md:py-16">
        <div className="flex flex-col items-center text-center space-y-6 md:space-y-8">
          ...
          <p className="text-sm md:text-base text-white/70 max-w-xl">
            Factory-direct custom furniture studio in Hyderabad, crafting sofas,
            beds, workspaces and storage for homes and offices.
          </p>
          ...
          <p className="text-xs md:text-sm text-white/50 pt-2">
            © {new Date().getFullYear()} VAMA Living. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
